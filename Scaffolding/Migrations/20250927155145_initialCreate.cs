    ...
    public partial class initialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__brands__5E5A8E2732D961DC", x => x.brand_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__categori__D54EE9B48D6DC531", x => x.category_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__customer__CD65CB85178DE79D", x => x.customer_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__invoices__3213E83F84824204", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__logs__9E2397E079601F1D", x => x.log_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__stores__A2F2A30C606C7C14", x => x.store_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__products__47027DF51E5D9A23", x => x.product_id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__invoice___BD4B37EB3B8122F5", x => new { x.id, x.invoice_id });
                    table.ForeignKey(
                        name: "FK__invoice_i__invoi__619B8048",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__staffs__1963DD9CD452B130", x => x.staff_id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__stocks__E68284D3F348CE2A", x => new { x.store_id, x.product_id });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__orders__46596229D07389BA", x => x.order_id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__order_it__837942D46F56A9BC", x => new { x.order_id, x.item_id });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "test eslam" });
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__staffs__AB6E6164C8E1EA38",
                schema: "sales",
                table: "staffs",
                column: "email",
                unique: true);
